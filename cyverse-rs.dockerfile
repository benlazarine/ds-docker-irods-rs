...
ENV CYVERSE_DS_CONTROL_PLANE_KEY=TEMPORARY__32byte_ctrl_plane_key
ENV CYVERSE_DS_NEGOTIATION_KEY=TEMPORARY_32byte_negotiation_key
ENV CYVERSE_DS_ZONE_KEY=TEMPORARY_zone_key
